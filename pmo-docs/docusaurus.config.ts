...
const config: Config = {
  ...
  organizationName: 'AliRezaBoroujerdian', // Usually your GitHub org/user name.
  projectName: 'pmo-docs', // Usually your repo name.
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl:
            'https://github.com/AliRezaBoroujerdian/pmo-docs/tree/main/',
        },
        blog: {
