...
!!! warning "نسخه قدیمی‌تر"
    نسخه جدیدتر موجود است! [👉 مشاهده نسخه 3.0 (آخرین نسخه)](../v3.0/overview.md)
    
    **نسخه‌های دیگر:** [📗 نسخه 1.0](../v1.0/overview.md) | **نسخه 2.0 (فعلی)**
...
[🏠 بازگشت به انتخاب نسخه](../../index.md) | [📗 نسخه 1.0](../v1.0/overview.md) | [👉 نسخه 3.0](../v3.0/overview.md)
